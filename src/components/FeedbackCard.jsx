...
const FeedbackCard = ({ content, name, title, img }) => 
  (
    <div className='flex justify-between flex-col px-10 py-10 rounded-[20px] max-w-[370px] md:mr-10px sm:mr-5 mr-0 feedback-card'><img src={quotes} alt="quotes" className="w-[42px] h-[27px] object-contain"/>
